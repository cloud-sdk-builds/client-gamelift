...
[`@aws-sdk/client-gamelift`](https://www.npmjs.com/package/@aws-sdk/client-gamelift/v/3.51.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-gamelift@3.51.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WUGs3VFh3MelEVV6XsPOy2LLpCTvesx2tjZ1h+ZwF7hqglHJMP6b60y1R8G1eFd2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-gamelift": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-gamelift@3.51.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-gamelift@3.51.0/index.min.mjs": "sha384-WUGs3VFh3MelEVV6XsPOy2LLpCTvesx2tjZ1h+ZwF7hqglHJMP6b60y1R8G1eFd2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-gamelift/blob/refs/tags/3.51.0/LICENSE
```
